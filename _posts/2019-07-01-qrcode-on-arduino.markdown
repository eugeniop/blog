...
date:   2019-07-01 15:58 -0800
categories: qrcode arduino eink
comments: true
author: Eugenio Pace
---

For [the e-Paper project I worked before]({% post_url 2019-06-21-experiments-with-e-paper-displays %}) I had to generate a QR code. The QR code encodes the login URL. The idea is that you point a phone's camera to it. Modern phones are configured to scan QRCodes automagically with their cameras and prompt the user to open a URL (the login URL in my case). Pretty convenient.
